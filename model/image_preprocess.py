...
def compute_aspect_preserved_bbox(bbox, increase_area, h, w):
    ...
    if max(left_oob, right_oob, top_oob, bot_oob) > 0:
        ...
        return left_t, top_t, right_t, bot_t  # No change in case of no out-of-bounds adjustments

def crop_source_image(source_img, save_img, face_detector=None): 
...
if __name__ == '__main__':
    source_img = "" 
    out_img = ""  
    crop_source_image(source_img, out_img)  
